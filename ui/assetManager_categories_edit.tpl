            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="post" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="name" name="name" value="{$category.name}" placeholder="{Lang::T('Enter category name')}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" id="status" name="status">
                                <option value="Active" {if $category.status == 'Active'}selected{/if}>{Lang::T('Active')}</option>
                                <option value="Inactive" {if $category.status == 'Inactive'}selected{/if}>{Lang::T('Inactive')}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button class="btn btn-success" type="submit">{Lang::T('Update Category')}</button>
