                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="category_id" name="category_id" required>
                                        ...
                                        <option value="{$category.id}" {if
                                            $category.id==$asset.category_id}selected{/if}>{$category.name}</option>
                                        {/foreach}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="brand_id" name="brand_id" required>
                                        ...
                                        <option value="{$brand.id}" {if $brand.id==$asset.brand_id}selected{/if}>
                                            {$brand.name}</option>
                                        {/foreach}
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="model_id" name="model_id" required>
                                        ...
                                        <option value="{$model.id}" {if $model.id==$asset.model_id}selected{/if}>
                                            {$model.name}</option>
                                        {/foreach}
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" readonly class="form-control" id="asset_tag" name="asset_tag"
                                        value="{$asset.asset_tag}" placeholder="{Lang::T('Enter unique asset tag')}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="serial_number" name="serial_number"
                                        value="{$asset.serial_number}" placeholder="{Lang::T('Enter serial number')}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" id="description" name="description" rows="3"
                                        placeholder="{Lang::T('Enter asset description')}">{$asset.description}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="number" step="0.01" class="form-control" id="purchase_cost"
                                        name="purchase_cost" value="{$asset.purchase_cost}" placeholder="0.00">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="lat" name="lat"
                                        value="{$asset.latitude}" placeholder="{Lang::T('Latitude')}" step="any">
                                    <small class="help-block">{Lang::T('Latitude (e.g., 6.5244)')}</small>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="lng" name="lng"
                                        value="{$asset.longitude}" placeholder="{Lang::T('Longitude')}" step="any">
                                    <small class="help-block">{Lang::T('Longitude (e.g., 3.3792)')}</small>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control select2" id="assigned_to" name="assigned_to">
                                        ...
                                        <option value="{$user.id}" {if $asset.assigned_to == $user.id}selected{/if}> {$user.fullname} - {$user.username} - {$user.email}</option>
                                        {/foreach}
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="status" name="status">
                                        <option value="Active" {if $asset.status=='Active' }selected{/if}>
                                            {Lang::T('Active')}</option>
                                        <option value="Inactive" {if $asset.status=='Inactive' }selected{/if}>
                                            {Lang::T('Inactive')}</option>
                                        <option value="Under Maintenance" {if $asset.status=='Under Maintenance'
                                            }selected{/if}>{Lang::T('Under Maintenance')}</option>
                                        <option value="Disposed" {if $asset.status=='Disposed' }selected{/if}>
                                            {Lang::T('Disposed')}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" id="condition_status" name="condition_status">
                                        <option value="Excellent" {if $asset.condition_status=='Excellent'
                                            }selected{/if}>{Lang::T('Excellent')}</option>
                                        <option value="Good" {if $asset.condition_status=='Good' }selected{/if}>
                                            {Lang::T('Good')}</option>
                                        <option value="Fair" {if $asset.condition_status=='Fair' }selected{/if}>
                                            {Lang::T('Fair')}</option>
                                        <option value="Poor" {if $asset.condition_status=='Poor' }selected{/if}>
                                            {Lang::T('Poor')}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control" id="notes" name="notes" rows="3"
                                        placeholder="{Lang::T('Additional notes')}">{$asset.notes}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="text-center">
                                <button class="btn btn-success" type="submit">{Lang::T('Update Asset')}</button>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('brand_id').addEventListener('change', function () {
            ...
            const currentModelId = '{$asset.model_id}';
            ...
            if (brandId) {
                ...
                fetch(url, {
                    ...
                    .catch(error => {
                        modelSelect.innerHTML = '<option value="">' + errorLoadingModelsText + ': ' + error.message + '</option>';
                    });
            }
        });
    ...
    function updateCoordinatesDisplay() {
        ...
        if (lat && lng) {
            // You can add any visual feedback here if needed
