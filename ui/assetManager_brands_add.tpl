            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="post" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="name" name="name" placeholder="{Lang::T('Enter brand name')}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" id="description" name="description" rows="3" placeholder="{Lang::T('Enter brand description')}"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="country" name="country" placeholder="{Lang::T('Enter country')}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="url" class="form-control" id="website" name="website" placeholder="{Lang::T('Enter website URL')}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button class="btn btn-success" type="submit">{Lang::T('Save Brand')}</button>
